    ...
    if (totalFilteredRocks === 0) {
      return (
        <div className="mt-3 p-3 bg-muted rounded border border-border text-center">
          <p className="text-xs text-muted-foreground">No rocks match the current filters</p>
        </div>
      );
    }
    ...
    return (
      <div className="mt-3 space-y-2">
        <div className="flex items-center gap-2 mb-2">
          <h4 className="text-xs font-bold text-accent uppercase tracking-wider">Quarterly Rocks</h4>
            ...
            <div key={quarter} className="bg-muted rounded border border-border">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-foreground">{quarterRocks.length} {quarterRocks.length === 1 ? 'Rock' : 'Rocks'}</span>
                </div>
              </button>
