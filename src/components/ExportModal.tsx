...
const EXPORT_SECTIONS: ExportSection[] = [
  ...
  },
  {
    ...
    label: "Capabilities",
    icon: <TrendingUpIcon className="h-4 w-4" />,
    description: "Key capabilities and their associated goals",
  },
  {
    id: "quarterly",
    label: "Quarterly Goals",
    icon: <CalendarIcon className="h-4 w-4" />,
    description: "Current quarter goals and ownership",
  },
  {
    id: "kpis",
      ...
      ${capabilities
        ...
        <div class="card" style="margin-bottom: 16px;">
          ...
          <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid #e5e9eb;">
            <div style="font-size: 11px; color: #727272; margin-bottom: 8px;">Associated Goals (${capabilityRocks.length})</div>
...
`;
  ...
  <div class="page">
    <div class="section">
      <div class="section-title">${currentQuarter} ${selectedYear} Goals</div>
      <div class="card">
        ${quarterRocks
          .map((rock: any) => {
            const statusClass =
